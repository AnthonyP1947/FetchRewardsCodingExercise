package com.mastercoding.fetchrewardscodingexercise;
...
public class IDRecyclerViewAdapter extends RecyclerView.Adapter<IDRecyclerViewAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.textView.setText ("Batch ");
        holder.textView.append (listIDs.get(position));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            button = itemView.findViewById(R.id.view_ids);
